...
function themNguoiDung(){
    console.log("khanhhnp2 themNguoiDung");
}
...
document.getElementById("btnLogin").addEventListener("click", function(){
    ...
    if(username === "cybersoft" && password === "cybersoft"){
        ...
        changeColor2("Login thanh cong", "alert alert-danger");
    }
})
 ...
 */
 ...
 var _querySelectorAll = document.querySelectorAll(".container .form-group")[1];
 console.log(_querySelectorAll);

 /**
  * Bài tập tính tiền típ
  */
